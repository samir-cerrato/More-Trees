...
datatype tree = datatype Tree.tree
val fromlist = Tree.fromlist
val tolist = Tree.tolist
val sort = Tree.sort
...
(* testing functions *)
fun cllToString(l : char list list) : string =
    case l of
        [] => "[]"
      | x :: xs => String.implode x ^ "::" ^ cllToString(xs)
    
fun test_charlist (s : string) (n : char list) (m : char list) : unit =
    case n = m of
        true => print ("Test " ^ s ^ " OK\n")
      | false => print ("Test " ^ s ^ " FAILED:\n    Expected: " ^ String.implode m ^ "\n    Got: " ^ String.implode n  ^ "\n")

fun test_charlist_list (s : string) (n : char list list) (m : char list list) : unit =
    case n = m of
        true => print ("Test " ^ s ^ " OK\n")
      | false => print ("Test " ^ s ^ " FAILED:\n    Expected: " ^ cllToString m ^ "\n    Got: " ^ cllToString n  ^ "\n")
